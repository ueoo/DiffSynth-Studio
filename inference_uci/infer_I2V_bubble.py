...
input_image = VideoData(
    "/viscam/data/two-phase-flow/bubble_boiling_100_uci_dataset_832x480/pair_001_cam1.mp4", height=480, width=832
)[0]
...
save_video(video, "wan_results/video_Wan2.2-I2V-A14B_bubble.mp4", fps=15, quality=5)
