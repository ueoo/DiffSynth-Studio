...
def main(args):
    ...
    if args.sdedit_strengths is not None and len(args.sdedit_strengths) > 0:
        ...
        sdedit_strengths = [0.6]

    exp_logs_root = "/svl/data/two-phase-flow/yuegao/gaussian_tpf_logs"
    exp_part = "tpf_real_charuco_dyn_2dgs_0612_icml"
    merged_folder = "uci_0612_2dgs_start00002_to_start00102dur1step1_whitebubble_icml_rebut_merged"
        ...
        for sdedit_strength in sdedit_strengths:
            ...
            for i in trange(num_samples, desc=f"GPU {args.gpu_idx}: {cam_name} (sdedit={strength_tag})"):
                out_path = os.path.join(
                    out_root,
                    f"video_Wan2_2_V2V_A14B_0612_regscale_{cam_name}_sdedit_strength{strength_tag}_"
