#!/usr/bin/env bash
# Finetune Wan 2.2 I2V *low-noise* LoRA on Blender flowers (dahlia). Same data as
# train_wan_i2v_blenderflowers_dahlia_high.sh but trains the low-noise model branch.
# Use this after or in addition to the high-noise LoRA for full I2V inference.
set -euo pipefail
...
OUTPUT_PATH="${OUTPUT_PATH:-/scr/yuegao/wan_models/train_blenderflowers/dahlia_low}"
