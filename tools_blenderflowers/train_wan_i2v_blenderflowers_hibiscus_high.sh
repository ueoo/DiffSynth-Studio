#!/usr/bin/env bash
# Finetune Wan 2.2 I2V on Blender flowers (hibiscus). Uses dataset renders/ with
...
OUTPUT_PATH="${OUTPUT_PATH:-/scr/yuegao/wan_models/train_blenderflowers/hibiscus_high}"
