#!/usr/bin/env bash
# Finetune Wan 2.2 I2V *low-noise* LoRA on Blender flowers (lily). Same data as
# train_wan_i2v_blenderflowers_lily_high.sh but trains the low-noise model branch.
set -euo pipefail
...
OUTPUT_PATH="${OUTPUT_PATH:-/scr/yuegao/wan_models/train_blenderflowers/lily_low}"
